...
public class NotificationsContainerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //NotificationContainerDisplayer notificationContainerDisplayer = new NotificationContainerDisplayer(user.getNewNotifications(), userGUI.getOldNotifications(), layout, this);
